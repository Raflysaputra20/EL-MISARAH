...
<aside class="admin-sidebar">
    ...
    <ul class="sidebar-menu">
        ...
        <li class="sidebar-item"><a href="../kelola_pengaduan/list_pengaduan.php" class="sidebar-link active"><i data-lucide="alert-triangle" class="sidebar-icon"></i> Pengaduan</a></li>
