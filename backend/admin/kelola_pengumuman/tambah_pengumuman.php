...
<head>
    ...
    <title>Buat Pengumuman - Admin Kost Elmi Sarah</title>
    ...
    <style>
        ...
        .form-icon-wrap {
            ...
            background-color: #e8f7f0; display: flex; align-items: center; justify-content: center;
        }
...
<aside class="admin-sidebar">
    ...
    <ul class="sidebar-menu">
        ...
        <li class="sidebar-item"><a href="list_pengumuman.php" class="sidebar-link active"><i data-lucide="megaphone" class="sidebar-icon"></i> Pengumuman</a></li>
        ...
        <div class="form-card clearfix">
            <div class="form-header">
                <div class="form-icon-wrap">
                    <i data-lucide="megaphone" style="width:24px; height:24px; color:var(--admin-green);"></i>
                </div>
                <div>
                    <h3 class="form-title">Form Pengumuman</h3>
                    <p class="form-subtitle">Isi detail pengumuman, Kegiatan atau Informasi untuk Penghuni</p>
                </div>
            </div>
            ...
            <form action="simpan_pengumuman.php" method="POST">
                <div class="mb-3">
                    ...
                    <input type="text" name="judul" class="form-control-custom" placeholder="Contoh: Perbaikan Listrik" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="isi" class="form-control-custom" rows="5" placeholder="Detail Pengumuman" required></textarea>
                </div>



                <button type="submit" class="btn-submit">
                    <i data-lucide="send" style="width:16px; height:16px;"></i> Terbitkan Pengumuman
                </button>
            </form>
        </div>
    </main>
