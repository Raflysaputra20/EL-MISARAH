...
<aside class="admin-sidebar">
    ...
    <ul class="sidebar-menu">
        ...
        <li class="sidebar-item"><a href="../kelola_booking/list_booking.php" class="sidebar-link active"><i data-lucide="calendar-check" class="sidebar-icon"></i> Kelola Booking</a></li>
